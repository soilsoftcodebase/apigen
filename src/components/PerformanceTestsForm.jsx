  ...
  return (
    <div className="mt-32  bg-white container p-16 max-w-full mx-auto ">
      <div className="container mx-auto p-6 max-w-full">
        ...
        <div className="mb-6 flex items-center justify-normal">
          ...
          <form className="space-y-6">
            ...
            <div className="animate-slide-up">
              ...
              <select
                ...
                className="mt-1 block w-full rounded-md border border-gray-300 shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-300"
              >
            ...
            <div className="animate-slide-up">
              ...
              <input
                ...
                } p-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 `}
